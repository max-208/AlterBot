module.exports = {
    ...
    async execute(message, args) {
        ...
        if (complete === true) {
            ...
            console.log(J1);
            console.log(J1);
            messagePublic = await message.channel.send("__**partie entre " + J1.username + "(j1) et " + J2.username + "(j2).**__");
            var round = 1;

            while (round <= 9 && equilibre > (max/100*10) && equilibre < (max - (max/100*10))) {
                ...
                //idee : faire barre de progression avec █ ▓ ▒ ░ █
                var text = "j1🔷";
