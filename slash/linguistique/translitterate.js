...
module.exports = {
	data: new SlashCommandBuilder()
        ...
        async execute(interaction){
            ...
            let result = "";
            if (interaction.options.getSubcommand() === 'lattogeorg'){
            ...
            else if (interaction.options.getSubcommand() === 'lattocyr'){
            ...
            else if (interaction.options.getSubcommand() === 'georgtolat'){
            ...
            else if (interaction.options.getSubcommand() == 'cyrtolat'){
                for (const iterator of text){
